...
//Get a user's info if you have their object ID
...
router.post('/', async (req, res) => {
    ...
    if (!req.body.firstName || !req.body.lastName || !req.body.username || !req.body.password
        || !req.body.discordUsername || !req.body.speedrunUsername)
      return res.status(400).send({
        message: "first name, last name, username, password, discordUsername, and speedrunUsername are required"
      });
    ...
    try {
      ...
      const user = new User({
        ...
        speedrunUsername: req.body.speedrunUsername
      });
      await user.save();
