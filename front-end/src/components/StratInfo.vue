...
<div class='rightContent colorLightPurple debug'>
  ...
  <div class='communityBox debug' v-if="tutorialVideos.length > 0">
    <p class='mainCommunityText debug'>Community Tutorials</p>
    <div  v-for='vid in tutorialVideos' :key='vid._id'>
      <div class='youtubeVideoBox debug'> 
        <iframe width="854" height="480" :src='vid.videoLink' frameborder="0" 
